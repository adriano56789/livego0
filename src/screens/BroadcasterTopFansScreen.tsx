...
interface BroadcasterTopFansScreenProps {
    ...
    return (
        <li className="flex items-center p-3 space-x-4">
            ...
            <div className="relative">
                ...
                <img src={`https://flagcdn.com/${user.country}.svg`} width="16" alt={user.country} className="absolute bottom-0 right-0 rounded-full border border-gray-800" />
            </div>
...
const BroadcasterTopFansScreen: React.FC<BroadcasterTopFansScreenProps> = ({ setActiveScreen, userId }) => {
...
export default BroadcasterTopFansScreen;