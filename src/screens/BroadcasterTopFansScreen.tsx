    ...
    return (
        <li className="flex items-center p-3 space-x-4">
            ...
            <div className="relative">
                ...
                <img src={`https://flagcdn.com/${country}.svg`} width="16" alt={country} className="absolute bottom-0 right-0 rounded-full border border-gray-800" />
            </div>
...
const BroadcasterTopFansScreen: React.FC<BroadcasterTopFansScreenProps> = ({ setActiveScreen }) => {
    const fans = [
