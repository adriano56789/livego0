    ...
    return (
        <div className="h-full w-full bg-[#121212] text-white overflow-y-auto no-scrollbar scroll-smooth flex flex-col font-sans select-none">
            ...
            <div className="mt-4 flex flex-col bg-[#121212] flex-1">
                <MenuItem icon={WalletIcon} color="text-[#fbbf24]" label="Carteira" onClick={() => onOpenWallet()} />
                ...
                {isAdmin && (
                    <>
                        ...
                        <div className="px-4 pt-6 pb-2">
                            <h3 className="text-gray-500 text-[10px] font-black uppercase tracking-[0.2em]">Ferramentas DEV</h3>
                        </div>
                        <MenuItem icon={SoundWaveIcon} color="text-cyan-400" label="API Tracker" onClick={onOpenApiTracker} />
                        <MenuItem icon={DatabaseIcon} color="text-cyan-400" label="Database Monitor" onClick={onOpenDatabaseMonitor} />
                        <MenuItem icon={ZapIcon} color="text-cyan-400" label="API Health Monitor" onClick={onOpenHealthMonitor} />
                        <MenuItem icon={ShieldIcon} color="text-cyan-400" label="App Integrity Tester" onClick={onOpenIntegrityTester} />
                        <MenuItem icon={CpuIcon} color="text-cyan-400" label="Full API Checkup (112)" onClick={onOpenFullApiCheckup} />
                    </>
                )}
