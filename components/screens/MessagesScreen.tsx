...
const MessagesScreen: React.FC<MessagesScreenProps> = ({ addToast, initialChatUser, onChatOpened }) => {
    ...
    const loadMessagesData = async () => {
        ...
        try {
            ...
            if (Array.isArray(online)) {
                const uniqueOnlineUsers = Array.from(new Map(online.map(user => [user.id, user])).values());
