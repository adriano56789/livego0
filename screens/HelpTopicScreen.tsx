    ...
    "Segurança da conta e privacidade": (
        <div className="space-y-4 text-left">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-300 pl-4">
                ...
                <li><strong>Proteção de Avatar:</strong> Ative a proteção de avatar no seu perfil para evitar que outros usem sua foto.</li>
            </ul>
        </div>
    ),
...
const HelpTopicScreen: React.FC<HelpTopicScreenProps> = ({ setActiveScreen, topic }) => {
    ...
    return (
        <div className="bg-[#121212] min-h-screen text-white flex flex-col">
            ...
            <main className="flex-grow p-6 text-gray-300 overflow-y-auto">
                {content}
            </main>
        </div>
    );
